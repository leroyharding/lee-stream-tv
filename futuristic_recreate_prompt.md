# Futuristic LeeStreamTV App Prompt (Logic-Focus, Cinematic Custom UI)

Copy and paste the markdown block below into any advanced LLM (such as Gemini 1.5 Pro, Claude 3.5 Sonnet, or GPT-4o) to recreate the complete functional logic of the **LeeStreamTV** standalone web application while styling it with a completely new, futuristic, and cinematic UI.
...
### 🎨 UI Design Requirement: Futuristic & Cinematic Experience
Do NOT copy the legacy layout or styling. Design a fresh, premium, and highly modern user experience. The interface must look visually spectacular and work flawlessly for both TV D-pad remote controls and pointers/mice.

**Overall Style**
Create a sleek, cinematic interface that feels like it belongs in the year 2035. The design should be:
- Ultra-modern, minimal but luxurious.
- Dark mode only, with a premium feel.
- Highly animated.
- Glassmorphism & frosted glass panels.
- Neon accent lighting & soft glow effects.
- Smooth gradients & floating interface elements.
- Rounded corners throughout & edge-to-edge movie artwork.
- Elegant typography & high-end streaming service appearance.
- The interface should feel alive even when idle.

**Color Palette**
- Background: Deep Black (#050505), Charcoal (#111111)
- Accent Colors: Electric Blue, Neon Purple, Cyan, Soft Pink, White highlights
- Use subtle animated gradient lighting throughout the UI. Avoid bright or flat colors.

**Typography**
- Modern sans-serif fonts (e.g. Outfit, Space Grotesk, Inter).
- Large cinematic titles, thin elegant subtitles.
- Perfect spacing, minimal text clutter.

**Home Screen**
Create a visually stunning landing page. Include:
- Large animated hero banner.
- Featured movie occupying the top half of the screen.
- Animated background, parallax scrolling, floating particles, slow moving light beams, gradient overlays.
- Movie information fades in elegantly.
- Large glowing Play button, Secondary Info button.
- Smooth auto-changing featured content.
- Below the hero section include horizontal carousels: Continue Watching, Trending, Popular, Action, Comedy, Sci-Fi, Drama, Recently Added, Top Rated.
- Each row should scroll horizontally with inertia. Movie cards should slightly tilt while moving.
- Hover animations: Scale up, Glow effect, Reflection animation, Shadow increase, Border illumination, Poster expands smoothly.

**Navigation**
- Floating navigation bar, semi-transparent glass, blur background, animated icons.
- Include: Home, Movies, TV Shows, Search, Downloads, Favorites, Profile.
- Active icon glows softly. Navigation transitions should be fluid.

**Search Screen**
- Beautiful futuristic search interface.
- Large search bar, animated cursor, typing animation, live search suggestions.
- Animated filter chips, Genre selector, Trending searches, Voice search button, Recent searches.
- Background particles.

**Movie Details Page**
- Large cinematic backdrop image.
- Slow zoom animation. Movie poster floats over background.
- Glass information card including: Movie title, Year, Runtime, Genres, Rating, Description, Cast, Director.
- Trailer button, Play button, Add to Favorites, Share button, Recommended movies.
- All buttons should animate when pressed. Background should slightly blur while scrolling.

**Categories Screen**
- Grid layout, animated category tiles, large artwork, gradient overlays.
- Hover glow, smooth scaling.

**Favorites & Downloads & Profile Screens**
- Favorites: Beautiful card layout, floating animations, heart animation when removing, smooth transitions.
- Downloads: Futuristic progress indicators, animated circular progress bars, glowing status indicators, glass cards.
- Profile: Modern avatar, animated statistics, Continue Watching progress, achievement badges, settings cards, hover animations.

**Animations & Effects**
- **Loading Animations**: Custom cinematic loading screen, animated logo, pulsing glow, particle effects, progress animation, skeleton loading placeholders. Movie posters fade into place.
- **Micro Animations**: Everything should animate smoothly (e.g., buttons ripple, cards float, icons bounce slightly, hover glow, press animations, smooth fade transitions, soft scaling, animated shadows, animated borders, elastic scrolling, momentum scrolling, glass reflections, background gradients slowly move).
- **Page Transitions**: Every page transition should feel cinematic (e.g., Fade, Zoom, Blur, Slide, Depth transition, Glass morph, Light sweep, Parallax, Motion blur, Shared element transitions). No instant page changes.
- **Background Effects**: Dynamic animated gradients, floating particles, moving light streaks, subtle stars, depth blur, aurora lighting, glow effects, soft lens flares, animated shadows, very subtle motion.
- **Movie Cards**: Large rounded posters, glass information overlay, rating badge. Hover animation: Scale, Glow, Tilt, Reflection, Poster expands, Text fades in, Watch button slides upward, Smooth shadow animation.
- **Buttons**: Large rounded buttons, soft neon glow, animated gradients, ripple effect, hover expansion, floating effect, glass appearance.
- **Scroll Experience**: Scrolling should feel premium. Inertia scrolling, parallax backgrounds, animated headers, rows gently move at different speeds, content fades into view.
- **Icons**: Modern outline icons, glowing active state, smooth morphing animations, animated notifications.

**Design Principles**
- Everything should feel expensive.
- Everything should move smoothly.
- No sharp edges. No static layouts. No flat design. No harsh transitions.
- Every interaction should provide visual feedback.
- The application should feel like a luxury streaming service mixed with a futuristic operating system. Aim for an experience that immediately impresses users with cinematic visuals, fluid animations, immersive motion, elegant glassmorphism, and premium attention to detail. The interface should look polished enough to be showcased as a flagship concept for the next generation of streaming platforms.
